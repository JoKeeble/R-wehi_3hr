---
layout: topic
title: Introducing the Awesome World of R
...
> ## Learning Objectives
>
> * Begin to discover the awesome power of using R 
> * Examine some of the backbones of R: functions, objects, vectors, matrices
...
We are now going to use our "cytokines" dataset to explore the `data.frame` data
structure.
